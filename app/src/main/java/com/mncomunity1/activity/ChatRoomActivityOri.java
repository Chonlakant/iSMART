...
import com.mncomunity1.adapter.ChatRoomThreadAdapter;
...
public class ChatRoomActivityOri extends AppCompatActivity {

    private String TAG = ChatRoomActivityOri.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // self user id is to identify the message owner
         selfUserId = getIntent().getStringExtra("chatId");
