...
import com.mncomunity1.activity.ChatRoomActivity;
import com.mncomunity1.activity.MainActivityTap;
    ...
    private void processChatRoomPush(String title, boolean isBackground, String data) {
        if (!isBackground) {
            ...
            try {
                ...
                if (uObj.getString("user_id").equals(IsmartApp.getInstance().getPrefManager().getUser().getId())) {
