...
import ismart.is.com.ismart.adapter.ChatRoomsAdapter;
...
import ismart.is.com.ismart.helper.SimpleDividerItemDecoration;
import ismart.is.com.ismart.model.ChatRoom;
import ismart.is.com.ismart.model.Message;


public class MainActivity2GCM extends AppCompatActivity {

    private String TAG = MainActivity2GCM.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new ChatRoomsAdapter.RecyclerTouchListener(getApplicationContext(), recyclerView, new ChatRoomsAdapter.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Log.e("sddd",chatRoom.getId()+chatRoom.getName());
                Intent intent = new Intent(MainActivity2GCM.this, ChatRoomActivity.class);
    ...
    private void launchLoginActivity() {
        Intent intent = new Intent(MainActivity2GCM.this, LoginActivity.class);
