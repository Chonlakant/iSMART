package ismart.is.com.ismart.gcm;
...
public class GcmIntentService extends IntentService {
    ...
    private void sendRegistrationToServer(final String token) {
        ...
        User user = IsmartApp.getInstance().getPrefManager().getUser();
        if (user == null) {
            // TODO
    ...
    public static void subscribeToTopic(String topic) {
        GcmPubSub pubSub = GcmPubSub.getInstance(IsmartApp.getInstance().getApplicationContext());
        InstanceID instanceID = InstanceID.getInstance(IsmartApp.getInstance().getApplicationContext());
        String token = null;
        try {
            token = instanceID.getToken(IsmartApp.getInstance().getApplicationContext().getString(R.string.gcm_defaultSenderId),
                    GoogleCloudMessaging.INSTANCE_ID_SCOPE, null);
            if (token != null) {
            ...
            Toast.makeText(IsmartApp.getInstance().getApplicationContext(), "Topic subscribe error. Topic: " + topic + ", error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
